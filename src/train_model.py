...
def train_and_save_model(data_path='data/credit_card_fraud_dataset.csv', model_path=MODEL_PATH):
    """Train Random Forest model and save it to disk along with feature metadata."""
    ...
    print("Training RandomForestClassifier(n_estimators=100, random_state=42, class_weight='balanced')...")
